...
export class ExperienceComponent {
  ...
  public elements: Experience[] = new Array<Experience>(
    new Experience("Shipping Lead", "Vibra-Tite", new Array<string>("Organizing and distributing daily workload", "Maintaining EDI data accuracy", "Handling and packaging of restricted hazardous materials", "Managing all DGIS reporting", "Performing logistics analysis to optimize shipping throughput", "Performing evaluations of team members as needed"), "June 2019", "Present"),
    new Experience("Shipping Clerk", "Vibra-Tite", new Array<string>("Packing orders for shipping", "Creating labels for orders", "Maintaining inventory accuracy"), "June 2015", "June 2019"),
